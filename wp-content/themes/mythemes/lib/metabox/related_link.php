...
function related_link_options() {
    $postTypeArrays = array('page','post','banners');
...
<div id="groundDiv" <?php echo $firstCls; ?> >       
    <table cellpadding="2" cellspacing="3" border="0" id='ground_floor' class='fontsize10'   style='font-size: 11px;'>
        <tr> 
            ...
            <td  class="right">
                <input type="textbox" name="link_heading" id="link_heading" value="<?php echo $link_heading; ?>" style="width: 100%;">
            </td>      
            ...
            <td>
                <select name="rl_link_target">
                    <option value="_self" <?php if($rl_link_target=="_self"){ echo "selected='selected'"; } ?>>Self</option>
                    <option value="_blank" <?php if($rl_link_target =="_blank"){ echo "selected='selected'"; } ?>>New tab</option>
                </select>     
            </td>
        </tr> 
    </table>
